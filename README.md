# <span style="color:blue; font-family:Trebuchet MS;">Real-Time SIEM Monitoring and Intrusion Detection System</span>

---

# <span style="color:blue; font-family:Trebuchet MS;">Project Overview</span>
...
# <span style="color:blue; font-family:Trebuchet MS;">SIEM Architecture Workflow</span>
...
# <span style="color:blue; font-family:Trebuchet MS;">1. Attacker Machine – Kali Linux</span>

## <span style="color:blue; font-family:Georgia;">Activities Performed</span>
...
# <span style="color:blue; font-family:Trebuchet MS;">2. Target Server – DVWA Vulnerable Web Application</span>

## <span style="color:blue; font-family:Georgia;">Implementation Activities</span>
...
# <span style="color:blue; font-family:Trebuchet MS;">3. Snort IDS – Intrusion Detection System</span>

## <span style="color:blue; font-family:Georgia;">Detection Functions</span>
...
## <span style="color:blue; font-family:Georgia;">Detection Examples</span>
...
# <span style="color:blue; font-family:Trebuchet MS;">4. Wazuh SIEM Platform</span>

## <span style="color:blue; font-family:Georgia;">Key Functionalities</span>
...
## <span style="color:blue; font-family:Georgia;">Log Sources</span>
...
# <span style="color:blue; font-family:Trebuchet MS;">5. Wazuh Dashboard</span>

## <span style="color:blue; font-family:Georgia;">Dashboard Monitoring Included</span>
...
# <span style="color:blue; font-family:Trebuchet MS;">Complete Workflow Lifecycle</span>
...
# <span style="color:blue; font-family:Trebuchet MS;">Technologies and Tools Used</span>
...
# <span style="color:blue; font-family:Trebuchet MS;">Skills Gained</span>
...
# <span style="color:blue; font-family:Trebuchet MS;">Project Outcome</span>
...
# <span style="color:blue; font-family:Trebuchet MS;">Future Enhancements</span>
...
# <span style="color:blue; font-family:Trebuchet MS;">Author</span>
